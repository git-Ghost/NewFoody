<%@page import="com.aws.dao.FOODY_STARBUCKS_MENU_DAO"%>
<%@page import="com.aws.dao.FOODY_KFC_MENU_DAO"%>
<%@page import="com.aws.domain.FOODY_STARBUCKS_MENU"%>
<%@page import="com.aws.domain.FOODY_KFC_MENU"%>
	...
	<div class="container-fluid">
		<div class="container-fluid" id="navigationbar">
			<nav class="navbar navbar-expand-sm">
				<a class="navbar-brand" href="./index"> <svg
				...
				%><ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link text-danger"
						href="./myProfile">Hi, <%=ses.getAttribute("name")%></a></li>
		...
		<div class="container-fluid" id="content">
			...
			<% String menuOption = request.getParameter("option");
				if(menuOption.equalsIgnoreCase("KFC")){
					...
					for(FOODY_KFC_MENU menu : temp) {
						
					pageContext.setAttribute("item_src", menu.getITEM_SRC());
					pageContext.setAttribute("item_name", menu.getITEM_NAME());
					pageContext.setAttribute("item_price", menu.getCURRENCY_CODE()+" "+menu.getITEM_PRICE());
					%>
				<div class="col">
				...
				else if(menuOption.equalsIgnoreCase("STAR")){
					FOODY_STARBUCKS_MENU_DAO contents = FOODY_STARBUCKS_MENU_DAO.getInstance();
					List<FOODY_STARBUCKS_MENU> temp = contents.getContent();
					for(FOODY_STARBUCKS_MENU menu : temp) {
