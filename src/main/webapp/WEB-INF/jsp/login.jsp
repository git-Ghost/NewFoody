...
%>
	<div class="container-fluid">
		...
		<form autocomplete="off" action="./console" method="post"
			name="loginForm">
			<center>
				<h2 style="font-weight: bold" width="20%" for="title">
					<font>LOGIN</font>
				</h2>
				<div class="card" style="width: 360px" id="register_block">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<label for="password">Password</label> <input type="password"
								...
								placeholder="e.g: Foody@123" onKeyup="checkform()" required>
						</div>
					...
					<div>
						<p>Don't have Account with us yet?</p>
