	...
	<div class="container-fluid">
		<form autocomplete="off" action="./Success" method="post">
			<center>
					...
					<div class="card-body">
						<div class="form-group">
							<label for="name">Name</label> <input type="text"
								placeholder="Full Name" class="form-control" id="name" name="name"
								maxlength="20"
								required pattern="^[a-zA-Z]+( [a-zA-Z]+)*$" title="Only max 20 digits of Alphabetic Character With Single Space is allowed between Characters"
								onkeyup="getCaps()" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode == 32">
		
						</div>
						<div class="form-group">
							<label for="email">Email</label> <input maxlength="20"
								type="email" placeholder="e.g. xyz@domain.com" class="form-control" id="email" name="email"
								required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Please Provide Vaild Mail Id"
						...
						<div class="form-group">
							...
							<input type="password"
								...
								class="form-control" id="confPwd" name="confPwd" onkeyup="checkPwd()">
						</div>
						<div align="center">
							<font size=4px> <input id="checkBox" type="checkbox"
								required"> I agree to the
								<div class="popup" onclick="myFunction()">
									<b>Terms and Conditions</b></font> <span class="popuptext"
								id="myPopup">Your Private data will be maintained by our
								team and you can't raise your voice against us</span>
						</div>
					</div>
					<br><br/> 
				...
				<div>
					<a href="./login">Already Has The Account with us? <b><u>Login Here</u></b></a>
				</div>
	</div>
	</center>
