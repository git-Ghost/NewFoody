...
public class DbUtil {
	...
	/**
	 * This method will return the org.hibernate.SessionFactory object upon which
	 * openSession() method can be called to get Session
	 * 
	 ...
	 * 
	 * @param tName
	 *            = table name which need to found out in the DB
	 ...
	 * 
	 * @param sqlFile
	 *            = Sql File Path From Resource Directory Ex, sqlFile =
	 *            "/USERS_TABLE_SCRIPT/createTable.sql"
	 * @return true = if table is created successfully false = if table creation is
	 *         failed
	 * 
	 */
